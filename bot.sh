...
git clone https://github.com/friday2su/owo-bot-clone.git

# Change directory to the cloned TicketBot folder
cd owo-bot-clone || { echo "Failed to change directory to TicketBot"; exit 1; }

# Display "INSTALLING NPM DEPENDENCIES" in blue and install discord.js
big_blue_text "INSTALLING NPM DEPENDENCIES"
npm install || { echo "Failed to install discord.js"; exit 1; }
